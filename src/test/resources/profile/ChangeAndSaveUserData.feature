Feature: Changing and saving user mail, name, password - Profile page
  ...
  Scenario: Verify functionality Changing the password
    When User login with test email and password legionqa.test@gmail.com : legiongq123
  ...
  Scenario: Verify functionality Logout button in UserPanel
    When User login with test email and password legionqa.test@gmail.com : legiongq123
    And User go to new Profile page
    And User clicks on Logout button in UserPanel
