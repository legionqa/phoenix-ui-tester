...
public class PhoenixUIOverviewPageTest {
    ...
    private pages.mySites.CampaignPage campaignPage;
    private pages.mySites.SitePage sitePage;
...
//    @And("Top navigation bar with the {string} of the page is visible")
//    public void topNavigationBarWithTheOfThePageIsVisible(String namePage) {
//        assertTrue(overviewPage.isNamePageInNavigationBarDisplayed(namePage));
//    }
...
//     Video player in all languages
    ...
    @Then("User verifys video is working in {string}")
    public void userVerifsVideoIsWorkingIn(String fileName) {
        assertTrue(overviewPage.isScreenShotExists(fileName));
    }
}
