...
import pages.myAdvertisement.CreateCampaignsPage;
import pages.mySites.CreateSitePage;
...
//    public static String OVERVIEW_PAGE_URL;
    ...
    public pages.mySites.CreateSitePage clickDropListButtonSite(String dropButton) {
        clickElementByXpath(String.format(DROP_DOWN_LIST_BUTTON, dropButton));
        return new pages.mySites.CreateSitePage();
    }

    public pages.myAdvertisement.CreateCampaignsPage clickDropListButtonCampaign(String dropButton) {
        clickElementByXpath(String.format(DROP_DOWN_LIST_BUTTON, dropButton));
        return new pages.myAdvertisement.CreateCampaignsPage();
    }
